...
export class Soundscape {
  constructor(){this.context=null;this.master=null;this.enabled=false;this.lastNote=0;this.note=0;this.night=false;this.lastBird=0;this.lastReel=0;}
  async start(){
    if(!this.context){
